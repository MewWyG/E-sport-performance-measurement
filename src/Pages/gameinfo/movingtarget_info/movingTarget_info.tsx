...
const instructions = [
  'บนหน้าจอจะมีเป้าหมายเคลื่อนที่ไปมา ผู้เล่นต้องใช้เมาส์คลิกให้โดนก่อนที่เป้าจะหายไป',
  'เมื่อคลิกโดน จะมีเป้าหมายใหม่ปรากฏขึ้นทันที โดยต้องเล่นให้ครบทั้งหมด 30 เป้าหมาย',
  'ระดับความยากจะค่อย ๆ เพิ่มขึ้น เช่น เป้าหมายเล็กลง เคลื่อนที่เร็วขึ้น หรือเปลี่ยนทิศทางยากขึ้น',
  'ในบางช่วงอาจมีหลายเป้าหมายพร้อมกัน ผู้เล่นต้องเลือกคลิกเฉพาะเป้าหมายที่ถูกต้อง',
]
        ...
        <section className="animate-sp-fade-in mx-auto max-w-4xl">
          ...
          <div className="rounded-sp-card border border-sp-border bg-sp-glass p-8 backdrop-blur-xl md:p-12">
            <div className="flex flex-col items-center gap-10 md:flex-row md:gap-12">
              ...
              <div className="flex-grow text-center md:text-left">
                ...
                <p className="mb-8 text-xl leading-relaxed text-sp-text-muted">
                  คลิกเป้าหมายที่เคลื่อนที่บนหน้าจอให้ทันก่อนที่เป้าจะหายไป
                  โดยผู้เล่นต้องเล่นให้ครบ 30 เป้าหมาย พร้อมระดับความยากที่เพิ่มขึ้นเรื่อย ๆ
                </p>
            ...
            <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3">
              <InfoBox label="จำนวนเป้าหมาย" value="30 เป้า" />
              <InfoBox
                label="วัดทักษะหลัก"
                value="การตอบสนอง / ความแม่นยำ"
              />
              <InfoBox
                label="ผลลัพธ์หลัก"
                value="เวลาเฉลี่ย / อัตราความแม่นยำ"
              />
            </div>
          </div>
        </section>
