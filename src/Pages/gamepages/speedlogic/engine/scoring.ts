...
export function calculateThroughput(correctAnswers: number, durationMs: number): number {
...
export function isAnswerTooFast(responseTimeMs: number): boolean {
  return responseTimeMs < SPEED_LOGIC_CONFIG.minAnswerDelayMs
}