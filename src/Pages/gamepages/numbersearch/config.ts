...
/**
 * margin ของพื้นที่วางตัวเลข หน่วยเป็น px
...
/**
 * ระยะห่างขั้นต่ำระหว่างจุดศูนย์กลางของตัวเลข หน่วยเป็น px
 * ค่านี้ใช้กันไม่ให้ตัวเลขอยู่ติดกันหรือทับกัน
 */
export const TILE_MIN_DISTANCE_PX = 96
 ...
 */
export const TILE_MIN_DISTANCE_FALLBACK_PX = 64